	...
	%---- Start: RIGHT Objects Creation
		...
		%~~~~ Start: Edit Size Slider Creation
			...
			uicontrol('Parent',REAVER_Fig...
					 ...
					 ,'BackgroundColor',[0.95,0.95,0.95]...
					 ,'Units','Normalized'...
					 ,'Position',[1478,808+12+12,186,30]./[1800,1036,1800,1036]...
					 ,'Max',15 ...
			...
			uicontrol('Parent',REAVER_Fig...
					 ...
					 ,'BackgroundColor',[0.8,0.8,0.8]...
					 ,'Units','Normalized'...
					 ,'Position',[1665,794+12+12,30,44]./[1800,1036,1800,1036]...
					 ,'String','1'...
                     ,'FontSize',6 ...
					 ,'FontWeight','Bold'...
					 ,'FontUnits','Normalized'...
		...
		%~~~~ Start: Create um/pix Text Box
			...
			uicontrol('Parent',REAVER_Fig...
					 ...
					 ,'BackgroundColor',[0.8,0.8,0.8]...
					 ,'Units','Normalized'...
					 ,'Position',[1614,696+29+16,110,36]./[1800,1036,1800,1036]...
		...
		%~~~~ Start: Edit Grey2Binary Threshold Slider Creation
			...
			uicontrol('Parent',REAVER_Fig...
					 ...
					 ,'BackgroundColor',[0.95,0.95,0.95]...
					 ,'Units','Normalized'...
					 ,'Position',[1665,584+50+22,64,30]./[1800,1036,1800,1036]...
					 ,'String','0.045'...
					 ,'FontWeight','Bold'...
					 ,'FontUnits','Normalized'...
					 ,'Enable','on'...
...
%%%%% Start: Iterate Through Each Image
	...
	%---- Start: Find all Vessel Diameters
		distanceImage	   = bwdist(~handles.derivedPic.BW_2) ;
		distanceValues	   = distanceImage .* handles.derivedPic.wire * 2 +1 ;
		VesselDiameters = num2cell( distanceValues(distanceValues>1) ) ;
	...
	%---- Start: Create References to Variables to Save
		...
		saveVariables.metrics.meanVesselDiam  = VesselDiameters ;
...
% Function to extract measurements from verified images. Under the hood it
% used reaver_quantify_network() to extract vessel statistics.
	handles = guidata(hObject) ;
...
%%%%% Start: Find Mean Vessel Diameter
	...
	VesselDiameters = mean( distanceValues(distanceValues>0) ) ;
%%%%% End: Find Mean Vessel Diameter
